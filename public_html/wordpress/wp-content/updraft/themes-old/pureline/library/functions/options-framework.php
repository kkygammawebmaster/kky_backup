...
<div id="header">
             <div class="theme-info">
				<span class="theme"><?php echo $purelinethemename; ?> <?php $purelinethemedata = get_theme_data( get_theme_root() . '/pureline/style.css' ); echo $purelinethemedata['Version']; ?></span>
