...
function pureline_copy() {
  ...
  if (!empty($options['pureline_affiliate_id'])) { $ad_affiliate_id = '?ap_id='.$options['pureline_affiliate_id']; } else { $ad_affiliate_id = ''; } 
	...
	$credits = '<p id="copyright"><span class="credits fl-r"><a href="http://theme4press.com/pure-line/'.$ad_affiliate_id.'">Pure Line</a> theme by <a href="http://theme4press.com/">Theme4Press</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;Powered by <a href="http://wordpress.org">WordPress</a></span> <a href="'. home_url() .'">'. get_bloginfo( 'name' ) .'</a>&nbsp;&nbsp;<small>'. get_bloginfo( 'description' ) .'</small></p>';
